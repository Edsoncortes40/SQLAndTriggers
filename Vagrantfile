...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
     ...
     sudo -u vagrant ln -s /vagrant .
     echo "PS1='424p2:\\w> '" >> ~vagrant/.bashrc
  SHELL
end

#     apt-get install -y postgresql postgresql-contrib python build-essential python-dev python-psycopg2 emacs tcsh
